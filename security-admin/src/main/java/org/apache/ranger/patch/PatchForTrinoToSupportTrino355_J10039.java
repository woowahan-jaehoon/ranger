...
@Component
public class PatchForTrinoToSupportTrino355_J10039 extends BaseLoader {
  private static final Logger logger = Logger.getLogger(PatchForTrinoToSupportTrino355_J10039.class);
  ...
  public static void main(String[] args) {
    logger.info("main()");
    try {
      PatchForTrinoToSupportTrino355_J10039 loader = (PatchForTrinoToSupportTrino355_J10039) CLIUtil
        .getBean(PatchForTrinoToSupportTrino355_J10039.class);
      loader.init();
